...
Listado.prototype.buscarRestaurante = function(id) {
    var restaurant =  this.restaurantes.find((restaurant)=>{
...
function eliminarRepetidos(array){
    var arraySinRepetidos = array.filter(function(elem, index, self) {
...
Listado.prototype.obtenerCiudades = function() {
    ...
    this.restaurantes.map((restaurant)=>{
        c.push(restaurant.ubicacion)
    })
...
Listado.prototype.obtenerHorarios = function() {
    ...
    this.restaurantes.map((restaurant)=>{
        arregloH.push(restaurant.horarios)
    })
